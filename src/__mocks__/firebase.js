  ...
  post: (dataNewBill) => {
    return Promise.resolve({
      data: [
        ...
        {
          id: dataNewBill.id,
          status: dataNewBill.status,
          pct: dataNewBill.pct,
          amount: dataNewBill.amount,
          email: dataNewBill.email,
          name: dataNewBill.name,
          vat: dataNewBill.vat,
          fileName: dataNewBill.filename,
          date: dataNewBill.date,
          commentAdmin: dataNewBill.commentAdmin,
          commentary: dataNewBill.commentary,
          type: dataNewBill.type,
          fileUrl: dataNewBill.fileUrl,
        },
      ],
    });
  },
